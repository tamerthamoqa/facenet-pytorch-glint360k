...
A pre-trained model on tripet loss with an accuracy of __98.22%__ on the LFW dataset is provided in the pre-trained model section. Although I would only use it for a __very small-scale facial recognition__.
...
### Pre-trained model
Link to download the 98.22% lfw accuracy pre-trained model using Triplet Loss [here](https://drive.google.com/file/d/1TkqK991DXepx2N2ReMk3ybBfE-pSu4l0/view?usp=sharing).
...
![roc](pretrained_model_stats_safe_to_delete/roc_resnet34_epoch_77_triplet.png "ROC Curve")
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| ResNet-34 | Tripet Loss | Hard-negatives | 140x140 | 512 | 0.2 | 544 | 32 | 0.075 | 77 | 5000 (385,000 training iterations) | __Adagrad__ (with weight_decay=1e-5, initial_accumulator_value=0.1, eps=1e-10) | 98.22%+-0.699 | 98.49%+-0.6 | 97.93%+-1.062 | 0.99833 | 87.79% | 0.96 |
